          ...
          <ul class="nav nav-list generic_category ">
            ...
            <?php foreach ($result_generic_category as $n) { ?>
              ...
              <li class="generic_category_box">
                <?php //print_r($result_sub_category); 
                //echo $n['generic_category_id'];
                //$result11_sub_category =  array();
                foreach ($result_sub_category as $p) {
                  $result11_sub_category = $p['rel_gen_category_id'];
                }
                 // echo "vishal".in_array($n['generic_category_id'],$result11_sub_category);
                ?>
